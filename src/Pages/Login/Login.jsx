...
function Login() {
    ...
    useEffect(()=>{
        document.title = "Magical Soul | Login"
    },[])
        ...
        <section className="card-body max-w-lg bg-gray-200 mx-auto rounded-3xl mb-14 text-black">
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-control my-6">
                    <button  type="submit" className="btn btn-neutral text-xl">Login</button>
                </div>
                <p className="text-lg">New here? <Link className="link text-blue-800" to='/sign-up'>Sign Up now!</Link></p>
            </form>
            <div className="divider">OR</div>
            <div className="flex flex-col gap-5">
                <button onClick={handleGoogleLogin} className="btn btn-block btn-outline md:text-xl font-bold"><Icon icon="devicon:google" /> Continue With Google</button>
            </div>
        </section>
    </>
}
